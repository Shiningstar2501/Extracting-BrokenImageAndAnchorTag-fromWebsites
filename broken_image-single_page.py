...
# Safely encode URL paths without double-encoding
...
def crawl_page(url, base_domain):
    ...
    try:
        ...
        # ✅ Conditional check inside <picture> tags
        for picture in soup.find_all('picture'):
            ...
            if img:
                ...
                # Only check <source> if not a CDN
        ...
        return []
# Crawl only the single given page
