...
def crawl_page(url, base_domain):
    ...
    try:
        ...
        #     for source in picture.find_all('source', srcset=True): // not for the cdn image 
        #         full_url = urljoin(url, source['srcset']) // not for the cdn image 
        #         check_image(full_url, url) //not for the cdn image 
